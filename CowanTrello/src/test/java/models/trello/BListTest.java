...
class BListTest
{
	...
	void testAddCardCardUser()
	{
		...
		l1.removeCard(card, Ownerl1);
		assertFalse(l1.hasCard(card));
	...
	void testAddCardCardIntUser()
	{
		...
		l1.removeCard(card5, Ownerl1);
		assertFalse(l1.hasCard(card5));
		...
		l1.removeCard(card6, Ownerl1);
		assertFalse(l1.hasCard(card6));
	...
	void testHasCard()
	{
		...
		l1.removeCard(newCard, Ownerl1);
		assertFalse(l1.hasCard(newCard));
